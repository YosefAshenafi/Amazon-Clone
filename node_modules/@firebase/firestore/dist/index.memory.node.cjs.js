...
function fillWritePipeline(remoteStore) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var remoteStoreImpl, lastBatchIdRetrieved, batch, e_5;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    remoteStoreImpl = debugCast(remoteStore);
...
function syncEngineWrite(syncEngine, batch, userCallback) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var syncEngineImpl, result, e_7, error;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                ...
                case 5:
                    e_7 = _e.sent();
                    error = wrapInUserErrorIfRecoverable(e_7, "Failed to persist write");
...
function registerPendingWritesCallback(syncEngine, callback) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var syncEngineImpl, highestBatchId, callbacks, e_8, firestoreError;
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    syncEngineImpl = debugCast(syncEngine);
                ...
                case 3:
                    e_8 = _e.sent();
                    firestoreError = wrapInUserErrorIfRecoverable(e_8, 'Initialization of waitForPendingWrites() operation failed');
...
function eventManagerListen(eventManager, listener) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        var eventManagerImpl, query, firstListen, queryInfo, _e, e_9, firestoreError, raisedEvent, raisedEvent_1;
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                case 0:
